...
def _replace(self, it, content, index):
    ...
    it - object from the framework that is derived from Core_element. 
    content - content to be inserted. 
    index - shows which "|||"(replacement expression) has to be replaced, starts from 0, in Core_element indexes are contained in the _indexes_list object
    """
...
def _clean(self, it, index):
    ...
    it - object from the framework that is derived from Core_element. 
    index - shows which "|||"(replacement expression) has to be cleaned.
    """
...
def _generate_target(self, trigger):
    ...
    trigger - is and id that has been generated by _generate_trigger
    """
